...
class $ExpensesTable extends Expenses with TableInfo<$ExpensesTable, Expense> {
  ...
  @override
  late final GeneratedColumnWithTypeConverter<CategoryType, int> category =
      GeneratedColumn<int>(
        'category',
        aliasedName,
        false,
        type: DriftSqlType.int,
        requiredDuringInsert: true,
      ).withConverter<CategoryType>($ExpensesTable.$convertercategory);
  @override
  ...
  static JsonTypeConverter2<CategoryType, int, int> $convertercategory =
...
class ExpensesCompanion extends UpdateCompanion<Expense> {
  ...
  final Value<CategoryType> category;
...
class $$ExpensesTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<CategoryType, int> get category =>
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<CategoryType> category = const Value.absent(),
              }) => ExpensesCompanion(
                id: id,
                title: title,
                amount: amount,
